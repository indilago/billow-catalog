...
import {CreateProductInput, CreateProductOutput, Entitlement, ModifyProductInput, Product} from '../../models/product'
    ...
    async listProducts(): Promise<Product[]> {
        const query = this.mapper.scan(DDBProduct, {
            filter: {
                subject: 'plan',
                type: 'Equals',
                object: PRODUCT_METADATA_VALUE,
                // object: { S: PRODUCT_METADATA_VALUE },
            },
        })
